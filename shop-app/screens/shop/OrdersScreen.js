...
import { FlatList, Text, Platform, View, StyleSheet, Button, ActivityIndicator } from 'react-native';
    ...
    if (error) {
        return (
			<View style={styles.centered}>
				...
				<Button title="Try again" onPress={ordersActions.fetchOrders} color={Colors.primary}/>
			</View>
		);
    }
